...
import {
    faBars, faPeopleArrows, faMicrophone, faLiraSign, faTimes, faCheckCircle, faUndo, faChevronRight,
    faChevronLeft, faMapPin, faMapMarkerAlt, faAngleDoubleDown, faMapMarkedAlt, faThLarge,
    faLevelDownAlt, faSortAmountDown, faShareAlt, faCaretRight, faPen
...
const PayDelivery = ({ navigation, route }) => {
    ...
    useEffect(() => {
        ...
        fetch('https://goldrich.top/api/rest/paymentaddress', {
            ...
            .then(response => response.json())
            .then((responseJson) => {
                //console.log('paymentaddress', responseJson);
                if (responseJson.success == 1) {
                    if (responseJson.data.address_id == '' || responseJson.data.address_id == null) {
                        ...
                        if (address[0] == null) {
                            setPaymentAddress(responseJson.data.addresses[0]);
                        } else {
        ...
        fetch('https://goldrich.top/api/rest/shippingaddress', {
            ...
            .then(response => response.json())
            .then((responseJson) => {
                //console.log('shippingaddress', responseJson);
                if (responseJson.success == 1) {
                    if (responseJson.data.address_id == '' || responseJson.data.address_id == null) {
                        ...
                        if (address[0] == null) {
                            setShippingAddress(responseJson.data.addresses[0]);
                        } else {
            ...
            <ScrollView>
                <View style={{ padding: 25, marginBottom: 120 }}>
                    ...
                    <View style={{ backgroundColor: 'white', marginTop: 20, paddingHorizontal: 20, borderRadius: 10, paddingBottom: 10 }}>
                        ...
                        {isLoadPaymentAdd && paymentAddress == null ? <ActivityIndicator /> :
                            <View>
                        ...
                        {isLoadShippingAdd && shippingAddress == null ? <ActivityIndicator /> :
                            <View>
                                <View style={{ marginTop: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <View style={{ flexDirection: 'row' }}>
